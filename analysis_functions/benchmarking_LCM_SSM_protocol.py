...
def print_other_data( data ):
    print "MC min:", min( data[ "MonteCarlo_acceptance_rate" ] ), "max:", max( data[ "MonteCarlo_acceptance_rate" ] ), "mean:", np.mean( data[ "MonteCarlo_acceptance_rate" ] )
...
plt.subplot( 325 )
plt.hist( using_native_full_glycan_benchmark_50_SSM_am1_3_mpt_data[ "MonteCarlo_acceptance_rate" ] )
plt.xlabel( "MonteCarlo_acceptance_rate" )
plt.xlim( [ 0, 100 ] )
plt.ylabel( "frequency" )

plt.subplot( 326 )
ymin = floor( min( using_native_full_glycan_benchmark_50_SSM_am1_3_mpt_data[ "atom_pair_constraint" ] ) )
ymax = ceil( max( using_native_full_glycan_benchmark_50_SSM_am1_3_mpt_data[ "atom_pair_constraint" ] ) )
plt.hist( using_native_full_glycan_benchmark_50_SSM_am1_3_mpt_data[ "atom_pair_constraint" ] )
plt.xlabel( "atom_pair_constraint" )
plt.xlim( [ ymin, ymax ] )
plt.ylabel( "frequency" )
