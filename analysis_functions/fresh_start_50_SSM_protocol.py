...
low_E_native_total_score = -479.07121909817215        # from sf with fa_intra_rep of 0.44
low_E_native_pseudo_interface_energy = -17.2075819372 # from sf with fa_intra_rep of 0.44
...
path_to_using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset = "/Users/Research/pyrosetta_dir/metric_data/fresh_start/using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset.csv"
using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset_data = pd.read_csv( path_to_using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset )
...
sc = plt.scatter( using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset_data[ "pseudo_interface_energy" ], marker='v', s=20, c="orange", clip_on=False )
...
ymins = [ floor(y), floor(min(using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset_data[ "pseudo_interface_energy" ])), floor(min(using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_data[ "pseudo_interface_energy" ])) ]
ymax = ceil( np.percentile(using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_data[ "pseudo_interface_energy" ], 80) )
...
sc = plt.scatter( x, y, marker='D', s=36, c="red", clip_on=False )
sc = plt.scatter( using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset_data[ "total_score" ], marker='v', s=20, c="orange", clip_on=False )
...
#plt.colorbar(sc)
ymins = [ floor(y), floor(min(using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset_data[ "total_score" ])), floor(min(using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_data[ "total_score" ])) ]
ymax = ceil( np.percentile(using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_data[ "total_score" ], 80) )
plt.xlabel( "Fc_glycan_rmsd" )
plt.xlim( [ -1, 10 ] )
...
y = low_E_native_pseudo_interface_energy
sc = plt.scatter( x, y, marker='D', s=36, c="red", clip_on=False )
sc = plt.scatter( using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_50_SSM_two_glycan_to_protein_atoms_tightest_am2_5_mpt_no_LCM_reset_data[ "pseudo_interface_energy" ], marker='v', s=20, c="orange", clip_on=False )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using SSM-50 on Fc glycan with LCM reset, two glycan to protein atoms tightest cst, ramp, am2, 5 mpt - compared against protocol without LCM reset"
...
path_to_using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset = "/Users/Research/pyrosetta_dir/metric_data/fresh_start/using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset.csv"
using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data = pd.read_csv( path_to_using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset )
...
y = low_E_native_pseudo_interface_energy
sc = plt.scatter( x, y, marker='D', s=36, c="red", clip_on=False )
sc = plt.scatter( using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data[ "pseudo_interface_energy" ], marker='v', s=20, c="orange", clip_on=False )
...
ymins = [ floor(y), floor(min(using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data[ "pseudo_interface_energy" ])), floor(min(using_native_full_glycan_50_SSM_am2_5_mpt_data[ "pseudo_interface_energy" ])) ]
ymax = ceil( np.percentile(using_native_full_glycan_50_SSM_am2_5_mpt_data[ "pseudo_interface_energy" ], 80) )
plt.xlabel( "Fc_glycan_rmsd" )
plt.xlim( [ -1, 10 ] )
plt.ylabel( "pseudo_interface_energy" )
plt.ylim( [ min(ymins) - 1, ymax + 1 ] )
...
y = low_E_native_total_score
sc = plt.scatter( x, y, marker='D', s=36, c="red", clip_on=False )
sc = plt.scatter( using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data[ "total_score" ], marker='v', s=20, c="orange", clip_on=False )
...
#sc = plt.scatter( using_native_full_glycan_50_SSM_am2_5_mpt_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_50_SSM_am2_5_mpt_data[ "total_score" ], c=using_native_full_glycan_50_SSM_am2_5_mpt_data[ "atom_pair_constraint" ] )
#plt.colorbar(sc)
ymins = [ floor(y), floor(min(using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data[ "total_score" ])), floor(min(using_native_full_glycan_50_SSM_am2_5_mpt_data[ "total_score" ])) ]
ymax = ceil( np.percentile(using_native_full_glycan_50_SSM_am2_5_mpt_data[ "total_score" ], 80) )
plt.xlabel( "Fc_glycan_rmsd" )
plt.xlim( [ -1, 10 ] )
plt.ylabel( "total_score" )
plt.ylim( [ min(ymins) - 5, ymax + 5 ] )
...
y = low_E_native_pseudo_interface_energy
sc = plt.scatter( x, y, marker='D', s=36, c="red", clip_on=False )
sc = plt.scatter( using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data[ "pseudo_interface_energy" ], marker='v', s=20, c="orange", clip_on=False )
...
x = 100.0
y = low_E_native_total_score
sc = plt.scatter( using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_50_SSM_am2_5_mpt_no_LCM_reset_data[ "total_score" ], marker='v', s=20, c="orange", clip_on=False )
sc = plt.scatter( x, y, marker='D', s=36, c="red", clip_on=False )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using SSM-50 on Fc glycan with LCM reset, ramp, am2, 5 mpt - compared against protocol without LCM reset"
plt.suptitle( plot_title, fontsize = 36 )
plt.subplots_adjust(top=0.93)
plt.savefig( plot_title, dpi=120, transparent=True )
plt.close()
