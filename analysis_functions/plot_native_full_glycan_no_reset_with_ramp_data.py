...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, with ramp, am2, 7 mpt"
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, Gal only cst with 2A flexibility, with ramp, am2, 7 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, tight Gal only cst with 0,5A flexibility, with ramp, am2, 7 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, Gal and its GlcNAc cst with 2A flexibility, with ramp, am2, 7 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, Gal and its GlcNAc tight cst with 0,5A flexibility, with ramp, am2, 7 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, with ramp, am3, 5 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, Gal only cst with 2A flexibility, with ramp, am3, 5 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, tight Gal only cst with 0,5A flexibility, with ramp, am3, 5 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, Gal and its GlcNAc cst with 2A flexibility, with ramp, am3, 5 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, Gal and its GlcNAc tight cst with 0,5A flexibility, with ramp, am3, 5 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, with ramp, am1, 5 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
#### 2 ####
###########
# am1, 5mpt, with ramp, Gal only cst with 2A flexibility
path_to_using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp = "/Users/Research/pyrosetta_dir/metric_data/using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp.csv"
using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data = pd.read_csv( path_to_using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp )
using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data = using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data.sort( "total_score")

fig = plt.figure(figsize=(30, 15))
sub1 = plt.subplot(2, 2, 1)
ymin = floor( min( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data.pseudo_interface_energy, 80 ) )
sub1.scatter( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] )
sub1.set_xlabel( "Fc_glycan_rmsd" )
sub1.set_xlim( [ 0, 2 ] )
sub1.set_ylabel( "pseudo_interface_energy" )
#sub1.set_ylim( [ ymin, ymax ] )
...
sub2 = plt.subplot(2, 2, 2)
ymin = floor( min( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "total_score" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data.total_score, 80 ) )
sub2.scatter( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "total_score" ] )
sub2.set_xlabel( "Fc_glycan_rmsd" )
sub2.set_xlim( [ 0, 2 ] )
sub2.set_ylabel( "total_score" )
#sub2.set_ylim( [ ymin, ymax ] )
...
ymin = floor( min( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data.pseudo_interface_energy, 80 ) )
sub3.scatter( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] )
sub3.set_xlabel( "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" )
sub3.set_xlim( [ 100, 0 ] )
sub3.set_ylabel( "pseudo_interface_energy" )
#sub3.set_ylim( [ ymin, ymax ] )
...
ymin = floor( min( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "total_score" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data.total_score, 80 ) )
sub4.scatter( using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_no_reset_Gal_am1_5_mpt_with_ramp_data[ "total_score" ] )
sub4.set_xlabel( "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" )
sub4.set_xlim( [ 100, 0 ] )
sub4.set_ylabel( "total_score" )
#sub4.set_ylim( [ ymin, ymax ] )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, Gal only cst with 2A flexibility, with ramp, am1, 5 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
#### 3 ####
###########
# am1, 5mpt, with ramp, tight Gal only cst with 0.5A flexibility
path_to_using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp = "/Users/Research/pyrosetta_dir/metric_data/using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp.csv"
using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data = pd.read_csv( path_to_using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp )
using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data = using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data.sort( "total_score")

fig = plt.figure(figsize=(30, 15))
sub1 = plt.subplot(2, 2, 1)
ymin = floor( min( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data.pseudo_interface_energy, 80 ) )
sub1.scatter( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] )
sub1.set_xlabel( "Fc_glycan_rmsd" )
sub1.set_xlim( [ 0, 2 ] )
sub1.set_ylabel( "pseudo_interface_energy" )
#sub1.set_ylim( [ ymin, ymax ] )
...
sub2 = plt.subplot(2, 2, 2)
ymin = floor( min( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "total_score" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data.total_score, 80 ) )
sub2.scatter( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "total_score" ] )
sub2.set_xlabel( "Fc_glycan_rmsd" )
sub2.set_xlim( [ 0, 2 ] )
sub2.set_ylabel( "total_score" )
#sub2.set_ylim( [ ymin, ymax ] )
...
ymin = floor( min( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data.pseudo_interface_energy, 80 ) )
sub3.scatter( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] )
sub3.set_xlabel( "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" )
sub3.set_xlim( [ 100, 0 ] )
sub3.set_ylabel( "pseudo_interface_energy" )
#sub3.set_ylim( [ ymin, ymax ] )
...
ymin = floor( min( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "total_score" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data.total_score, 80 ) )
sub4.scatter( using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_no_reset_Gal_tight_am1_5_mpt_with_ramp_data[ "total_score" ] )
sub4.set_xlabel( "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" )
sub4.set_xlim( [ 100, 0 ] )
sub4.set_ylabel( "total_score" )
#sub4.set_ylim( [ ymin, ymax ] )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, tight Gal only cst with 0,5A flexibility, with ramp, am1, 5 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
#### 4 ####
###########
# am1, 5mpt, with ramp, Gal and its GlcNAc cst with 2A flexibility
path_to_using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp = "/Users/Research/pyrosetta_dir/metric_data/using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp.csv"
using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data = pd.read_csv( path_to_using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp )
using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data = using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data.sort( "total_score")

fig = plt.figure(figsize=(30, 15))
sub1 = plt.subplot(2, 2, 1)
ymin = floor( min( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data.pseudo_interface_energy, 80 ) )
sub1.scatter( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] )
sub1.set_xlabel( "Fc_glycan_rmsd" )
sub1.set_xlim( [ 0, 2 ] )
sub1.set_ylabel( "pseudo_interface_energy" )
#sub1.set_ylim( [ ymin, ymax ] )
...
sub2 = plt.subplot(2, 2, 2)
ymin = floor( min( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "total_score" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data.total_score, 80 ) )
sub2.scatter( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "total_score" ] )
sub2.set_xlabel( "Fc_glycan_rmsd" )
sub2.set_xlim( [ 0, 2 ] )
sub2.set_ylabel( "total_score" )
#sub2.set_ylim( [ ymin, ymax ] )
...
ymin = floor( min( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data.pseudo_interface_energy, 80 ) )
sub3.scatter( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] )
sub3.set_xlabel( "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" )
sub3.set_xlim( [ 100, 0 ] )
sub3.set_ylabel( "pseudo_interface_energy" )
#sub3.set_ylim( [ ymin, ymax ] )
...
ymin = floor( min( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "total_score" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data.total_score, 80 ) )
sub4.scatter( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_am1_5_mpt_with_ramp_data[ "total_score" ] )
sub4.set_xlabel( "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" )
sub4.set_xlim( [ 100, 0 ] )
sub4.set_ylabel( "total_score" )
#sub4.set_ylim( [ ymin, ymax ] )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, Gal and its GlcNAc cst with 2A flexibility, with ramp, am1, 5 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
...
#### 5 ####
###########
# am1, 5mpt, with ramp, Gal and its GlcNAc_tight tight cst with 0.5A flexibility
path_to_using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp = "/Users/Research/pyrosetta_dir/metric_data/using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp.csv"
using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data = pd.read_csv( path_to_using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp )
using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data = using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data.sort( "total_score")

fig = plt.figure(figsize=(30, 15))
sub1 = plt.subplot(2, 2, 1)
ymin = floor( min( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data.pseudo_interface_energy, 80 ) )
sub1.scatter( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] )
sub1.set_xlabel( "Fc_glycan_rmsd" )
sub1.set_xlim( [ 0, 2 ] )
sub1.set_ylabel( "pseudo_interface_energy" )
#sub1.set_ylim( [ ymin, ymax ] )
...
sub2 = plt.subplot(2, 2, 2)
ymin = floor( min( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "total_score" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data.total_score, 80 ) )
sub2.scatter( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "Fc_glycan_rmsd" ], using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "total_score" ] )
sub2.set_xlabel( "Fc_glycan_rmsd" )
sub2.set_xlim( [ 0, 2 ] )
sub2.set_ylabel( "total_score" )
#sub2.set_ylim( [ ymin, ymax ] )
...
ymin = floor( min( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data.pseudo_interface_energy, 80 ) )
sub3.scatter( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "pseudo_interface_energy" ] )
sub3.set_xlabel( "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" )
sub3.set_xlim( [ 100, 0 ] )
sub3.set_ylabel( "pseudo_interface_energy" )
#sub3.set_ylim( [ ymin, ymax ] )
...
ymin = floor( min( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "total_score" ] ) )
ymax = ceil( np.percentile( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data.total_score, 80 ) )
sub4.scatter( using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" ], using_native_full_glycan_no_reset_Gal_and_its_GlcNAc_tight_am1_5_mpt_with_ramp_data[ "total_score" ] )
sub4.set_xlabel( "Fc_glycan_to_Fc_protein_Fnat_tot_contacts_recovered_10A" )
sub4.set_xlim( [ 100, 0 ] )
sub4.set_ylabel( "total_score" )
#sub4.set_ylim( [ ymin, ymax ] )
...
# save the plot
plt.tight_layout()
plot_title = "3ay4 using native using SSM-50 on Fc glycan and no reset, Gal and its GlcNAc tight cst with 0,5A flexibility, with ramp, am1, 5 mpt"
plt.suptitle( plot_title, fontsize = 24 )
plt.subplots_adjust(top=0.90)
plt.savefig( plot_title, dpi=120, transparent=True )
'''
