...
metrics_dump_dir = working_dir + "temp_glyco_dir"
try:
...
if not os.path.isdir( structure_dir ):
    try:
        ...
        pass
working_pose_decoy_name = structure_dir + '/' + working_pdb_name + "_glycosylated_then_random_reset"
...
print "Running PyJobDistributor..."
