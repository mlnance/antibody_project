...
while not jd.job_complete:
    ...
    num_lcm_accept = 0
    num_mc_checks = 0
    for ii in range( 1, input_args.num_LCM_trials + 1 ):
        ...
        if input_args.ramp_sf:
            ...
            sugar_sf = ramp_score_weight( sugar_sf, "fa_atr", FA_ATR_ORIG, ii - 1, input_args.num_LCM_trials )
            sugar_sf = ramp_score_weight( sugar_sf, "fa_rep", FA_REP_ORIG, ii - 1, input_args.num_LCM_trials )
