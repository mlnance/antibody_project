...
'''
SAMPLE INPUT
run glycan_sampling_just_small_or_shear_moves.py project_structs/lowest_E_double_pack_and_min_only_native_crystal_struct_3ay4_Fc_FcgRIII.pdb project_structs/lowest_E_double_pack_and_min_only_native_crystal_struct_3ay4_Fc_FcgRIII_removed_Fc_sugar.pdb /Users/Research/antibody_project/send_to_louis/project_glyco_files/3ay4_Fc_Glycan.iupac /Users/Research/antibody_project/send_to_louis/project_utility_files/ /Users/Research/pyrosetta_dir/test_pdb_dir/ 2 5
'''
...
metrics_dump_dir = working_dir + "smsh_%s_dir" %str( input_args.num_small_shear_moves )
try:
...
if not os.path.isdir( structure_dir ):
    try:
        ...
        pass
working_pose_decoy_name = structure_dir + '/' + working_pdb_name + "_glycosylated_then_just_%s_SmSh_moves" %input_args.num_small_shear_moves
...
while not jd.job_complete:
    ...
    num_smsh_accept = 0
    num_mc_checks = 0
    for ii in range( 1, input_args.num_small_shear_moves + 1 ):
        # if score ramping is desired
        if input_args.ramp_sf:
            ...
            main_sf = ramp_score_weight( main_sf, 
                                         ...
                                         FA_ATR_ORIG, 
                                         ii - 1, 
                                         input_args.num_small_shear_moves )
            main_sf = ramp_score_weight( main_sf, 
                                         "fa_rep", 
                                         FA_REP_ORIG, 
                                         ii - 1, 
