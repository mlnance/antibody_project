...
# example command: run make_low_E_struct_through_sample_domain_motions.py native_crystal_struct_3ay4_Fc_FcgRIII.pdb 3ay4_interface_loops.txt /Users/Research/pyrosetta_git_repo/structures_from_jazz --nstruct=1
