...
def main( in_working, working_info, in_native, native_info, in_sf, decoy_num, dump_dir, util_dir, MC_acceptance_rate = None, native_constraint_file = None, res_of_torsional_interest1 = None, res_of_torsional_interest2 = None ):
    """
    ...
    # pseudo interface energy
    # I get this for everything else, but I can't when there is not FcR
    # so I am just putting 0 for now
    metric_data.append( "pseudo_interface_energy:" )
    metric_data.append( str( 0 ) )
