...
def main( in_working, working_info, in_native, native_info, in_sf, JUMP_NUM, decoy_num, dump_dir, util_dir, MC_acceptance_rate = None, native_constraint_file = None ):
    ...
    working_Fc_glycan_data = Fc_glycan_metrics( working, native, working_info.Fc_glycan_chains, native_info.native_Fc_glycan_chains, sf, decoy_num, dump_dir )
    ...
    working_GlcNAc_to_Phe_contacts = check_GlcNAc_to_Phe_contacts( working, GlcNAc_to_Phe_cutoff, native = False )
